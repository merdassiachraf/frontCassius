    ...
    return (
      <div id="classicformpage">
        <MDBView src="https://images.pexels.com/photos/27406/pexels-photo-27406.jpg?cs=srgb&dl=building-modern-glass-tall-27406.jpg&fm=jpg">
          <MDBMask className="d-flex flex-column justify-content-center align-items-center gradient">
            <div className="d-flex align-items-start">
              ...
              <div className="d-flex flex-column align-items-start mr-2">
                <label className="white-text">
                  <MDBIcon icon="flag-checkered" size="lg" />
                  &nbsp; Country :
                </label>
                <Select
              ...
              <div className="d-flex flex-column align-items-start  mr-3">
                <label className="white-text">
                  <MDBIcon icon="street-view" size="lg" />
                  &nbsp; State :
                </label>
            ...
            <div className="d-flex profilesPage mt-4 flex-wrap">{profileItems}</div>
          </MDBMask>
        </MDBView>
      </div>
    );
